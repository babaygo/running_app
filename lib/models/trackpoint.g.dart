...
extension TrackPointQueryFilter
  ...
  QueryBuilder<TrackPoint, TrackPoint, QAfterFilterCondition> accuracyIsNull() {
  ...
  QueryBuilder<TrackPoint, TrackPoint, QAfterFilterCondition> latitudeIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
        property: r'latitude',
      ));
